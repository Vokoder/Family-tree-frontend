...
export const PLACE_OF_BIRTHDAY = 'Место рождения';
export const DATE_OF_DEATH = 'Дата смерти';
export const PLACE_OF_DEATH = 'Место смерти';
export const RELATED_LOCATIONS = 'Связанные места';
...
export const CONTACT_INFORMATION = 'Контактная информация';
...
export const SEARCH_MIDDLE_NAME = 'Введите отчество';
export const SELECT_GENDER = 'Выберите пол';
export const SEARCH_PLACE_OF_BIRTHDAY = 'Введите место рождения';
export const SEARCH_PLACE_OF_DEATH = 'Введите место смерти';
